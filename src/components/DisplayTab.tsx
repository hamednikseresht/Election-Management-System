...
export function DisplayTab({ 
  ...
  return (
    <div className="h-full overflow-y-auto p-4 sm:p-6 flex flex-col font-sans bg-slate-100 text-slate-800 transition-colors">
      
      {/* Only the Sync Button */}
            ...
            {isDual && (
              <div className="w-full flex-1">
                {!data.election1.active && !data.election2.active && (
                  <div className="rounded-3xl p-12 text-center my-auto border bg-white border-slate-200 shadow-md">
